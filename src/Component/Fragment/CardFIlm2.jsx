    ...
    <>
      <div className="relative lg:ml-2">
        <div {...(props === "Premium" && { className: "relative" })} {...props}>
          <div className="w-[280px] mr-[-26px] lg:mr-0  rounded-3xl">
            <img src={image} className="lg:w-[280px] w-[220px] h-[280px] lg:h-[360px] rounded-xl" alt="" />
            ...
            {series === "Top 10" ? <TopRate variant="absolute bg-red-700 top-0 right-14 lg:right-8" children={series} /> : null}
          </div>
        </div>
      </div>
    </>
